import os #Variable items = LSMB (Property nickname)
import xlrd
...
if __name__ == "__main__":
    ...
    # Define the folder path with the current date and the 'LSMB' subfolder
    today_directory = os.path.join(base_directory, f"Extract {current_date}", "LSMB")

    # Perform conversion for today's 'LSMB' subfolder
    ...
    # Define paths for 'LSMB' subfolder of the latest Saturday and Sunday folders
    saturday_directory = os.path.join(base_directory, f"Extract {last_saturday}", "LSMB")
    sunday_directory = os.path.join(base_directory, f"Extract {last_sunday}", "LSMB")

    # Perform conversion for the latest Saturday and Sunday 'LSMB' subfolders
