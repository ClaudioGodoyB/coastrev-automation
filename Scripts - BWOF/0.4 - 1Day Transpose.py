...
def transpose_data_to_template():
    ...
    # File paths
    source_file = fr'C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Extracts\Extract {today_str}\BWOF\10437_metrics_{today_display}_*.xlsx'
    ...
    prefix = f"10437_metrics_{today_display}"
    source_actual = None
