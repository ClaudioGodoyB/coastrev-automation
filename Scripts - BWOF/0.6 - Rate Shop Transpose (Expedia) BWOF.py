import os #Variable items = BWOF (Property nickname), 108832220 (Expedia Property ID)
...
try:
    ...
    destination_path = r"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Templates\BWOF.xlsx"

    # Find the source file with the [Expedia Property ID #] in the title
    source_file = None
    for file_name in os.listdir(source_folder):
        if '108832220' in file_name.lower():
