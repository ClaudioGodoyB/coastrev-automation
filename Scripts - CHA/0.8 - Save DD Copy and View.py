import xlwings as xw #Variables = CHA [Property Nickname]
import os
from datetime import datetime

try:
    # File path to your destination file
    file_path = r"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Templates\CHA.xlsx"
    ...
    new_file_path = os.path.join(destination_folder, f"CHA {current_date}.xlsx")
