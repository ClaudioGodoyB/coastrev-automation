import os #Variable items = MSI (Property nickname)
import xlrd
...
if __name__ == "__main__":
    ...
    # Define the folder path with the current date and the 'MSI' subfolder
    today_directory = os.path.join(base_directory, f"Extract {current_date}", "MSI")

    # Perform conversion for today's 'MSI' subfolder
    ...
    # Define paths for 'MSI' subfolder of the latest Saturday and Sunday folders
    saturday_directory = os.path.join(base_directory, f"Extract {last_saturday}", "MSI")
    sunday_directory = os.path.join(base_directory, f"Extract {last_sunday}", "MSI")

    # Perform conversion for the latest Saturday and Sunday 'MSI' subfolders
