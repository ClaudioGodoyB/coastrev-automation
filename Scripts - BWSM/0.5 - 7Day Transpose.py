...
def transpose_7day_data_to_template():
    try:
        ...
        file_date_str = target_date.strftime("%d_%b_%Y")  # e.g. 14_Apr_2025

        # File paths
        source_dir = fr'C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Extracts\Extract {folder_date_str}\BWSM'
        ...
        for fname in os.listdir(source_dir):
            if fname.startswith(f'05232_metrics_{file_date_str}') and fname.endswith('.xlsx'):
