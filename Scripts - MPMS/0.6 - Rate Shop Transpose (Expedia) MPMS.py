import os #Variable items = MPMS (Property nickname), 1571482 (Expedia Property ID)
...
try:
    ...
    destination_path = r"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Templates\MPMS.xlsx"

    # Find the source file with the [Expedia Property ID #] in the title
    source_file = None
    for file_name in os.listdir(source_folder):
        if '1571482' in file_name.lower():
