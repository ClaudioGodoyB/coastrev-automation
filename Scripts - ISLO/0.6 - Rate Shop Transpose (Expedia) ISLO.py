import os #Variable items = ISLO (Property nickname), 12356430 (Expedia Property ID)
...
try:
    ...
    destination_path = r"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Templates\ISLO.xlsx"

    # Find the source file with the [Expedia Property ID #] in the title
    source_file = None
    for file_name in os.listdir(source_folder):
        if '12356430' in file_name.lower():
