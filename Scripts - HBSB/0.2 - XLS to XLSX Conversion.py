import os #Variable items = HBSB (Property nickname)
import xlrd
...
if __name__ == "__main__":
    ...
    # Define the folder path with the current date and the 'HBSB' subfolder
    today_directory = os.path.join(base_directory, f"Extract {current_date}", "HBSB")

    # Perform conversion for today's 'HBSB' subfolder
    ...
    # Define paths for 'HBSB' subfolder of the latest Saturday and Sunday folders
    saturday_directory = os.path.join(base_directory, f"Extract {last_saturday}", "HBSB")
    sunday_directory = os.path.join(base_directory, f"Extract {last_sunday}", "HBSB")

    # Perform conversion for the latest Saturday and Sunday 'HBSB' subfolders
