import os #Variable items = HBSB (Property nickname), 4037044 (Expedia Property ID)
...
try:
    ...
    destination_path = r"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Templates\HBSB.xlsx"

    # Find the source file with the [Expedia Property ID #] in the title
    source_file = None
    for file_name in os.listdir(source_folder):
        if '4037044' in file_name.lower():
