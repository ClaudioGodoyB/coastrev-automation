import os #Variables = 'HBSB' [Propery nickname], 'noreply@cloudbeds.com' [Sender email], 'rooms sold and occupancy' [Email subject], '
...
try:
    ...
    base_dir = rf"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Extracts\Extract {today_str}\HBSB"
    ...
    for msg in messages:
        if (msg.SenderEmailAddress.lower() == "noreply@cloudbeds.com" and
            ...
            msg.Subject.strip().lower() == "rooms sold and occupancy".lower()):
