...
class PathManager:
    ...
    def __init__(self):
        ...
        self.WINDOWS_TO_LINUX = {
            r'C:\Users\johnj\Downloads': f"{self.VM_BASE}/data/downloads",
            r'C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Extracts': f"{self.VM_BASE}/data/extracts", 
            r'C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Details': f"{self.VM_BASE}/data/daily_details",
            r'C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Templates': f"{self.VM_BASE}/templates/excel",
            r'C:\Users\johnj\Desktop\CoastRev\Reporting': f"{self.VM_BASE}/data",
            r'C:\Users\johnj\Desktop\CoastRev': f"{self.VM_BASE}",
        }
