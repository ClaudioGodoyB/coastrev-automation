...
if __name__ == "__main__":
    ...
    # Define the folder path with the current date and the 'CSI' subfolder
    today_directory = os.path.join(base_directory, f"Extract {current_date}", "CSI")

    # Perform conversion for today's 'CSI' subfolder
    ...
    # Define paths for 'CSI' subfolder of the latest Saturday and Sunday folders
    saturday_directory = os.path.join(base_directory, f"Extract {last_saturday}", "CSI")
    sunday_directory = os.path.join(base_directory, f"Extract {last_sunday}", "CSI")

    # Perform conversion for the latest Saturday and Sunday 'CSI' subfolders
