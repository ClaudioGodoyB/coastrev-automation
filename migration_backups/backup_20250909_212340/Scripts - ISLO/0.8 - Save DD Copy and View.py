import xlwings as xw #Variable items = ISLO (Property nickname)
import os
from datetime import datetime

try:
    # File path to your destination file
    file_path = r"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Templates\ISLO.xlsx"
    ...
    new_file_path = os.path.join(destination_folder, f"ISLO {current_date}.xlsx")
