import openpyxl # TLMB [Property nickname],'Rooms Sold' [Extract file name snippet]
from datetime import datetime
import os

# Define base paths
base_source_folder = r"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Extracts"
destination_file = r"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Templates\TLMB.xlsx"

# Get today's date
today = datetime.now().date()

# Construct today's extract path
source_folder = os.path.join(base_source_folder, f"Extract {today.strftime('%Y-%m-%d')}", "TLMB")
