import os #Variables = LOL [Property nickname], line 31 [Target email Subject]
...
try:
    ...
    base_dir = rf"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Extracts\Extract {today_str}\LOL"
    ...
    for msg in messages:
        if (msg.SenderEmailAddress.lower() == "noreply@cloudbeds.com" and
            ...
            msg.Subject.strip().lower() == "Rooms Sold and Occupancy - LOL".lower()):
