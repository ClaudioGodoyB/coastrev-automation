import openpyxl # LOL [Property nickname],'Rooms Sold' [Extract file name snippet]
...
source_folder = os.path.join(base_source_folder, f"Extract {today.strftime('%Y-%m-%d')}", "LOL")
