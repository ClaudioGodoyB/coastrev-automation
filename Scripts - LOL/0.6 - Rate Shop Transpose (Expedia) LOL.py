import os #Variables = LOL [Property Nickname], 894003 [Expedia Prop #]
...
try:
    ...
    destination_path = r"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Templates\LOL.xlsx"

    # Find the source file with the [Expedia Property ID #] in the title
    source_file = None
    for file_name in os.listdir(source_folder):
        if '894003' in file_name.lower():
