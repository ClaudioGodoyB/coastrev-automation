import os #Variable items = HATH (Property nickname), 95523062 (Expedia Property ID)
...
try:
    ...
    destination_path = r"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Templates\HATH.xlsx"

    # Find the source file with the [Expedia Property ID #] in the title
    source_file = None
    for file_name in os.listdir(source_folder):
        if '95523062' in file_name.lower():
