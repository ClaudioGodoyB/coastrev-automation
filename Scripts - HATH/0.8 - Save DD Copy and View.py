import xlwings as xw #Variable items = HATH (Property nickname)
import os
from datetime import datetime

try:
    # File path to your destination file
    file_path = r"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Templates\HATH.xlsx"
    ...
    new_file_path = os.path.join(destination_folder, f"HATH {current_date}.xlsx")
