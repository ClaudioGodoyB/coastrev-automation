import os #Variable items = HATH (Property nickname)
import xlrd
...
if __name__ == "__main__":
    ...
    # Perform conversion for today's 'HATH' subfolder
    ...
    # Define paths for 'HATH' subfolder of the latest Saturday and Sunday folders
    saturday_directory = os.path.join(base_directory, f"Extract {last_saturday}", "HATH")
    sunday_directory = os.path.join(base_directory, f"Extract {last_sunday}", "HATH")

    # Perform conversion for the latest Saturday and Sunday 'HATH' subfolders
