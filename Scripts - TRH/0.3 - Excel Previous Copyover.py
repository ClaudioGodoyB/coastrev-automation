import openpyxl # Variable items = TRH (Property nickname), line 13 range (columns)

try:
    # Load the Excel file
    file_path = r"C:\Users\johnj\Desktop\CoastRev\Reporting\Daily Templates\TRH.xlsx"
