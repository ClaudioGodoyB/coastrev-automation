import os #Manual edits at lines 69 + 70 + 72 + 78 + 79 + 80 + 82
import xlrd
...
if __name__ == "__main__":
    ...
    # Define the folder path with the current date and the 'RRM' subfolder
    today_directory = os.path.join(base_directory, f"Extract {current_date}", "RRM")

    # Perform conversion for today's 'RRM' subfolder
    ...
    # Define paths for 'RRM' subfolder of the latest Saturday and Sunday folders
    saturday_directory = os.path.join(base_directory, f"Extract {last_saturday}", "RRM")
    sunday_directory = os.path.join(base_directory, f"Extract {last_sunday}", "RRM")

    # Perform conversion for the latest Saturday and Sunday 'RRM' subfolders
